...
function SentFileMessage({ content, renderMessageImages }: {
...
export const SentUserFileMessage = memo(function SentUserFileMessage({ node, renderMessageImages }: PropsRuntime<'conversation.chat.node', 'user'>): ReactNode {
  return <SentFileMessage content={node.data.content} renderMessageImages={renderMessageImages} />
})

/** Steering-message equivalent of the durable user projection. */
export const SentSteeringFileMessage = memo(function SentSteeringFileMessage({ node, renderMessageImages }: PropsRuntime<'conversation.chat.node', 'steering'>): ReactNode {
  return <SentFileMessage content={node.data.content} renderMessageImages={renderMessageImages} />
})
