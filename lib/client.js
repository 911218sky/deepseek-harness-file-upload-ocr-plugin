window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/sky/code/deepseek-harness-file-upload-ocr-plugin/src/client/FileAttachments.module.css.mjs
		const css$1 = ".crEFWW_hidden{display:none}.crEFWW_buttonRoot{align-items:center;min-width:0;display:inline-flex}.crEFWW_attachButton,.crEFWW_remove{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;display:inline-flex}.crEFWW_attachButton{border-radius:8px;width:28px;height:28px}.crEFWW_attachButton:hover:not(:disabled),.crEFWW_remove:hover{background:var(--dsw-alias-interactive-bg-hover)}.crEFWW_attachButton:disabled{cursor:wait;opacity:.55}.crEFWW_error{max-width:220px;color:var(--dsw-static-red-600);text-overflow:ellipsis;white-space:nowrap;margin-left:6px;font-size:12px;overflow:hidden}.crEFWW_rail{width:min(100%, var(--dsh-composer-card-max-width));flex-wrap:wrap;gap:8px;display:flex}.crEFWW_card{border:1px solid var(--dsw-alias-border-l2);width:min(260px,100%);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);border-radius:10px;align-items:center;gap:8px;padding:8px 8px 8px 10px;display:flex}.crEFWW_fileIcon{width:28px;height:28px;color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-50);border-radius:7px;flex:none;justify-content:center;align-items:center;display:inline-flex}.crEFWW_pdf{color:#b42318;background:#fee4e2}.crEFWW_image{color:#6941c6;background:#f4ebff}.crEFWW_word{color:#175cd3;background:#eff8ff}.crEFWW_excel{color:#027a48;background:#ecfdf3}.crEFWW_powerpoint{color:#c4320a;background:#fff4ed}.crEFWW_text{color:#475467;background:#f2f4f7}.crEFWW_generic{color:var(--dsw-static-deepseek-500);background:var(--dsw-static-deepseek-50)}.crEFWW_details{flex-direction:column;flex:auto;min-width:0;display:flex}.crEFWW_name{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:500;overflow:hidden}.crEFWW_size{color:var(--dsw-alias-label-tertiary);font-size:11px}.crEFWW_remove{border-radius:6px;flex:none;width:24px;height:24px}";
		...
		function FileAttachButton({ attach, attachImage }) {
			...
			const upload = async (selected) => {
				...
				setError(null);
				try {
					const directImages = attachImage !== void 0 && selected.some((file) => file.type.startsWith("image/")) && window.confirm("選取的圖片要直接提供給支援視覺的模型嗎？\n\n按「確定」：所有圖片直接提供原圖\n按「取消」：所有圖片使用本機 OCR");
		...
		//#endregion
		//#region \0dsh-css:/home/sky/code/deepseek-harness-file-upload-ocr-plugin/src/client/SentFileMessage.module.css.mjs
