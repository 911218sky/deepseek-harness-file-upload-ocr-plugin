window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function FileAttachmentRail({ sessionId, useInput, files, remove }) {
			...
			const snapshot = (0, react.useSyncExternalStore)((listener) => sessionId === void 0 ? () => {} : files.subscribe(sessionId, listener), () => sessionId === void 0 ? EMPTY_FILES$1 : files.get(sessionId));
