window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									className: import_FileAttachments_module_css.default.size,
									children: [
										(0, _deepseek_ai_dsh_client_ui_primitives.fileSizeText)(file.size),
										" · ",
										file.kind
									]
								})]
		...
		const SentUserFileMessage = (0, react.memo)(function SentUserFileMessage({ node, renderMessageImages }) {
		...
		const SentSteeringFileMessage = (0, react.memo)(function SentSteeringFileMessage({ node, renderMessageImages }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SentFileMessage, {
				content: node.data.content,
				renderMessageImages
			});
